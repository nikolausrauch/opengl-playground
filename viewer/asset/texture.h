...
public:
    ...
    static result_type_tex load(opengl::context& context, const std::filesystem::path& path);
    ...
    static result_type_cube load_cube(opengl::context& context, const std::array<std::filesystem::path, 6>& paths);
};
